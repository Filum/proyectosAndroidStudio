...
public class JuegoAvanzado extends AppCompatActivity {
    ...
    public void reinicioJuego()
    {
        ...
        seteo=(ImageButton)findViewById(R.id.tarjeta10);
        seteo.setClickable(true);
        seteo.setImageResource(R.drawable.trophy);
        flipIt(seteo);

        seteo=(ImageButton)findViewById(R.id.tarjeta11);
        seteo.setClickable(true);
        seteo.setImageResource(R.drawable.trophy);
        flipIt(seteo);

        seteo=(ImageButton)findViewById(R.id.tarjeta12);
        seteo.setClickable(true);
        seteo.setImageResource(R.drawable.trophy);
        flipIt(seteo);


        seteo=(ImageButton)findViewById(R.id.tarjeta13);
        seteo.setClickable(true);
        seteo.setImageResource(R.drawable.trophy);
        flipIt(seteo);

        seteo=(ImageButton)findViewById(R.id.tarjeta14);
        seteo.setClickable(true);
        seteo.setImageResource(R.drawable.trophy);
        flipIt(seteo);

        seteo=(ImageButton)findViewById(R.id.tarjeta15);
        seteo.setClickable(true);
        seteo.setImageResource(R.drawable.trophy);
        flipIt(seteo);
    ...
    public void abrirCarta(String deporte,ImageButton cartaSeleccionada)
    {
        ...
        switch (deporte)
        {
            ...
            case "baseball":
                ...
                break;
            case "golf":
                cartaSeleccionada.setImageResource(R.drawable.golf);
                break;
            case "pingpong":
                cartaSeleccionada.setImageResource(R.drawable.pingpong);
                break;
    ...
    public void clickCarta13(View view)
    {
        flipIt((ImageButton)findViewById(R.id.tarjeta13));
        abrirCarta(cartas.get(12),(ImageButton)findViewById(R.id.tarjeta13));
    }

    public void clickCarta14(View view)
    {
        flipIt((ImageButton)findViewById(R.id.tarjeta14));
        abrirCarta(cartas.get(13),(ImageButton)findViewById(R.id.tarjeta14));
    }

    public void clickCarta15(View view)
    {
        flipIt((ImageButton)findViewById(R.id.tarjeta15));
        abrirCarta(cartas.get(14),(ImageButton)findViewById(R.id.tarjeta15));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_avanzado);
...
*/      //CambiarModo(Preferencias.bandera);
        iniciarJuego();
    ...
    {
        seteo=(ImageButton)findViewById(R.id.tarjeta1);
        seteo.setBackgroundColor(c);
    }

    public void CambiarModo(int bandera)
    {
        if (bandera==1)
        {
            cambiaColor(Color.parseColor("#141313"));
        }else
        {
            cambiaColor(Color.parseColor("#E55D44"));
        }
    }
